...
// func (sn *FlatNode[K, VT, V, VList]) FillStrOffsets(v V, strOffsets map[string]flatbuffers.UOffsetT, fieldConfigs []FieldConfig) {
...
// func (sn *FlatNode[K, VT, V, VList]) FillVectorOffsetsMap(vList []V, strOffsets map[string]flatbuffers.UOffsetT) []map[string]flatbuffers.UOffsetT {
...
// func (sn *FlatNode[K, VT, V, VList]) FillVFields(v V, strOffsets map[string]flatbuffers.UOffsetT, vectorOffsetsMap map[string]flatbuffers.UOffsetT) flatbuffers.UOffsetT {
